...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        User::create([
            'name' => 'Planet Presents Admin',
            'email' => 'planetpresents.web@gmail.com',
            'password' => env('ADMIN_PASSWORD_2', 'password'),
            'role' => 'admin',
        ]);
        ...
        Charity::insert([
            [
                ...
                'preview_image' => 'north-east-trees.jpg',
            ...
            [
                ...
                'preview_image' => 'coral-gardeners.jpg',
            ...
            [
                ...
                'preview_image' => 'marine-mammal-care-center.jpg',
            ...
            [
                ...
                'preview_image' => 'friends-of-the-la-river.jpg',
